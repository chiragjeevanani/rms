                        ...
                        filteredOrders.map(order => (
                          ...
                          >
                             ...
                             <td className="px-8 py-5 text-right">
                                <span className="text-xl font-bold text-slate-950 tracking-tighter block leading-none">₹{order.grandTotal}</span>
                             </td>
                             <td className="px-8 py-5 text-center">
                      ...
                      <div className="flex-1 overflow-y-auto p-10 border-r border-slate-100 bg-white no-scrollbar">
                         <div className="flex justify-between items-end mb-10">
                            ...
                            <div className="text-right">
                               ...
                               <p className="text-4xl font-black text-blue-600 tracking-tighter leading-none italic">₹{selectedOrder.grandTotal}</p>
                            </div>
                         </div>
                            ...
                            <div className="space-y-2.5">
                               ...
                               <div className="relative group">
                                  ...
                                  <input 
                                    ...
                                    className="w-full h-11 bg-slate-50 border border-slate-100 rounded-xl pl-11 text-xs font-semibold outline-none focus:ring-1 focus:ring-slate-900 transition-all"
                                  />
                               </div>
                            </div>
                            <div className="space-y-2.5">
                         ...
                         <div className="space-y-2.5 mb-10">
                            ...
                            <div className="relative group">
                               ...
                               <input 
                                 ...
                                 className="w-full h-11 bg-slate-50 border border-slate-100 rounded-xl pl-11 text-xs font-semibold outline-none focus:ring-1 focus:ring-slate-900 transition-all font-sans"
                               />
                            </div>
                         </div>
                         ...
                         <div className="space-y-4">
                            ...
                            {selectedOrder.items.map((item, idx) => (
                               <div key={idx} className="flex justify-between items-center py-2.5 px-4 bg-slate-50 rounded-xl border border-slate-100">
                                  ...
                                  <span className="text-sm font-bold text-slate-950">₹{item.price * item.quantity}</span>
                               </div>
                            ))}
                         </div>
                      </div>
                                  ...
                                  {[
                                     ...
                                     <button
                                       ...
                                       className={`w-full h-16 rounded-2xl border flex items-center px-6 gap-4 transition-all ${
                                          paymentMethod === mode.id ? 'bg-slate-900 border-slate-900 text-white shadow-xl shadow-slate-900/10' : 'bg-white border-slate-100 text-slate-400 hover:text-slate-900'
                                       }`}
                                     >
                         ...
                         <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                               ...
                               <button 
                                 ...
                                 className="h-12 bg-slate-900 text-white rounded-xl text-[9px] font-bold uppercase tracking-widest hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/10 flex items-center justify-center gap-2 active:scale-95 disabled:opacity-50"
                               >
