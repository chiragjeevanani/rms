    ...
    <div className="p-8 space-y-8 animate-in fade-in duration-500 min-h-screen bg-[#FDFCFB]">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="px-5 py-2.5 bg-emerald-500 text-emerald-950 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-3 shadow-2xl shadow-emerald-500/20">
            <Calendar size={14} />
            {orders.length} ACTIVE TODAY
          </div>
        </div>
      </div>
